...
def RRJ2(x_train, grad_x_train, k = 30, code_size1 = 120, code_size2 = 60, batch_size=20,          gamma = 1.0, epsilon = 0.1, Lambda=10.0, iter_num = 40, steps_number = 1000, learning_rate = 0.0001):
    N = x_train.shape[0]
    ...
    recover = Model(training_data)
    grad_phi_psi = Gradients(training_data)
    ...
    rand_grad_phi_psi = Gradients(rand_training_data)
    new_grad_phi_psi = Gradients(gradient_training_data)
    grad_drei = Drei(gradient_training_data)
